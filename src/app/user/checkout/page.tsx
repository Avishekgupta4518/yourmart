...
function Checkout() {
  ...
  // Update address when userData changes
  useEffect(() => {
    if (userData) {
  ...
  useEffect(() => {
    const fetchAddress = async () => {
      if (!position) return; // check if position exists
      try {
    ...
    <div className="w-[92%] md:w-[80%] mx-auto py-10 relative">
      ...
      <Link href="/user/cart">
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          className="absolute left-0 top-2 flex items-center gap-2 text-green-700 hover:text-green-800 font-semibold transition-all"
        >
      ...
      <motion.h2
        ...
        className="text-2xl sm:text-3xl md:text-4xl font-bold text-green-700 text-center mt-16"
      >
        🛒 Checkout
      </motion.h2>
            ...
            <div className="relative mt-6 h-82.5 rounded-xl overflow-hidden border border-gray-200 shadow-inner">
              {position && (
                <MapContainer
                  ...
                  className="w-full h-full rounded-md border-2 border-green-700"
                >
                  <TileLayer
...
justify-center z-999"
        ...
        `}
          ...
          <div className="border-t pt-4 text-gray-700 space-y-2 text-sm sm:text-base">
            ...
            <div className="flex justify-between font-bold text-lg mt-2 pt-3 border-t">
...
text-white py-3 rounded-full hover:bg-green-700 transition-all bg-green-600 font-semibold"
          >
            {paymentMethod == "cod" ? "Place Order" : "Pay Online & Place Order"}
          </motion.button>
        </motion.div>
      </div>
    </div>
